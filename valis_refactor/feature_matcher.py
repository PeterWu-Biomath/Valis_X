...
import warp_tools
from _valtils import print_warning
import feature_detectors
...
def filter_matches_ransac(kp1_xy, kp2_xy, ransac_val=DEFAULT_RANSAC, method=USAC_MAGSAC_NAME):
    ...
    if kp1_xy.shape[0] >= 4:
        ...
        print_warning(msg, traceback_msg=traceback_msg)
...
def filter_matches_tukey(src_xy, dst_xy, tform=transform.SimilarityTransform()):
    ...
    tform = type(tform).from_estimate(src=dst_xy, dst=src_xy)
    M = tform.params
